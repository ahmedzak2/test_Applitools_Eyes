...
public class InvoiceGeneratorPage {
    ...
    //HEADER
    private By alret = By.cssSelector("#is-acknowledgement-modal > div > form > div.pb-6.px-4.sm\\:px-8.align-right.w-full.flex.justify-end > button");
    private By invoiceTitleField        = By.id("invoice-title");
    private By logoInput                = By.cssSelector("#tailwind > div > div > div > div.hidden.md\\:block > div > div.col-span-3 > div.shadow-lg.bg-white > div > div.invoice-detail-body.px-10.py-8 > div.invoice-detail-title.flex.justify-between > div.photo-drop.rounded.border.border-gray-400.py-2.px-5 > div > div");
...
public void clickOnlink(){
        driver.findElement(alret).click();;
}
